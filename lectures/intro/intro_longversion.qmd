...
- Distributing lecture material: **student Github repository** [(link)](https://github.com/uchicago-harris-dap/student30538-w26)
    - Repo includes Conda environment for this course: `environment.yml`
...
## Making    a copy of lecture slides

1. On the Github website, create a **fork** of the course repo (https://github.com/uchicago-harris-dap/student30538-w26). 
\vspace{2ex}
2. Go to your new fork and clone that repo to your computer. We will show how to do this in today's minilesson in lab.
